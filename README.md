...
The Nanopore_xyz_Library.zip contains coordinate files of the nanopores as a library to facilitate future theoretical studies of these nanopores. The zipped folder contains 'xyz' coordinate files for N=1 to N=5 and zipped coordinate files for N=6 to N=19. For N=20, due to its excessive size, coordinate files are saved as 16 parts in the zipped folder stable_nanopores20.zip.

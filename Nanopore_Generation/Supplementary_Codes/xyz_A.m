...
%This function uses the same algorithm of xyz.m. This is just a different version of that to
%generate xyz files using representative coordinates (input A) and saved
%data.
 s=24.64;
  cent=[];
sh=s/2;

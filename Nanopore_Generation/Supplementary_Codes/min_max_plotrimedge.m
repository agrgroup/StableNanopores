...
%This function uses the same algorithm used for generating all the
%properties and saving them. This is just a different version of that to
%generate and plot them separately
 s=24.64;
 bl=zeros(n*3,2);
     cent=[];
sh=s/2;
